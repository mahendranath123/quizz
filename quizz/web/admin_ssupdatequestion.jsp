...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            if (questionId != null && question != null && option1 != null && option2 != null && option3 != null && option4 != null && correctOption != null) {
                String sql = "UPDATE social_studies_questions SET question = ?, opt1 = ?, opt2 = ?, opt3 = ?, opt4 = ?,  correct_option = ? WHERE question_id = ?";
                ...
                if (rowsAffected > 0) {
                    out.println("<div>Question updated successfully.</div>");
                } else {
                    out.println("<div>No question found with the provided ID.</div>");
                }
            } else {
                out.println("<div>Missing parameters.</div>");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
