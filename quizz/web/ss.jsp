...
<head>
    ...
    <title>Social Studies Quiz</title>
    <style>
        body {
        ...
        function submitAnswers() {
            ...
            questions.forEach(question => {
                ...
                if (!selectedOption) {
                    ...
                    hiddenInput.value = 'none'; // Set value to 'none' for unselected questions
...
<body>
    <div class="container">
        <h1>Social Studies Questions</h1>
        <div class="timer" id="timer">00:50</div>
        <form id="quizForm" action="ss.jsp" method="post">
        <%!
            ...
            public boolean saveUserSelection(int questionId, String selectedOption) throws SQLException, ClassNotFoundException {
                ...
                try {
                    con = getConnection();
                    String sql = "INSERT INTO ssuser_answers (question_id, selected_option) VALUES (?, ?) ON DUPLICATE KEY UPDATE selected_option = VALUES(selected_option)";
        ...
        <%
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                if (allInserted) {
                    response.sendRedirect("ss_results.jsp"); 
                    return;
                } else {
                    if (errorOccurred) {
        ...
        <%
            ...
            try {
                con = getConnection();
                String sql = "SELECT * FROM social_studies_questions";
                pstmt = con.prepareStatement(sql);
