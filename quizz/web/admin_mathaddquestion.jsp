...
<head>
    ...
    <title>Admin Add Math Question</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2>Add New Math Question</h2>
            <form action="admin_mathaddquestion.jsp" method="post">
    ...
    <%
        ...
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            if (con != null && question != null && option1 != null && option2 != null && option3 != null && option4 != null && correctOption != null && !correctOption.isEmpty()) {
                String sql = "INSERT INTO math_questions(question, opt1, opt2, opt3, opt4, correct_option) VALUES (?, ?, ?, ?, ?, ?)";
