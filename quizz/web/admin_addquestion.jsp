...
<head>
    ...
    <title>Admin Add Finance Question</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2>Add New Finance Question</h2>
    ...
    <%
        ...
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            if (con != null && question != null && option1 != null && option2 != null && option3 != null && option4 != null && correctOption != null && !correctOption.isEmpty()) {
                String sql = "INSERT INTO finance_questions(question, opt1, opt2, opt3, opt4, correct_option) VALUES (?, ?, ?, ?, ?, ?)";
                try (PreparedStatement pstmt = con.prepareStatement(sql)) {
                    ...
                    pstmt.executeUpdate();
                    message = "Finance question added successfully.";
                ...
                message = "Please fill in all fields and select the correct option.";
            }
        }
    %>
    <%
